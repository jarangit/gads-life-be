...
/* ─────────────────────────────────────────────
 *  Realistic gadget product catalog
 * ───────────────────────────────────────────── */
...
/* ─────────────────────────────────────────────
 *  Brand → category mapping (ให้ดูสมจริง)
 * ───────────────────────────────────────────── */
const BRAND_TO_CATEGORIES: Record<string, number[]> = {
  Sony: [0, 1, 2, 8],         // หูฟัง, ลำโพง, สมาร์ทโฟน, กล้อง
  Samsung: [0, 2, 4, 5],      // หูฟัง, สมาร์ทโฟน, สมาร์ทวอทช์, แท็บเล็ต
  Apple: [0, 1, 2, 3, 4, 5],  // ครบ consumer
  JBL: [0, 1],
  Bose: [0, 1],
  Anker: [0, 6],              // หูฟัง, อุปกรณ์ชาร์จ
  Xiaomi: [0, 2, 4, 6, 9],
  Logitech: [7],              // โต๊ะ
  Marshall: [0, 1],
  Sennheiser: [0],
...
/** Seeded pseudo-random (มั่นใจว่าผลซ้ำได้เสมอ) */
